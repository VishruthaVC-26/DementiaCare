...
//    Spanned result;
    ...
    public void game2(View view) {
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.gaspmobilegames.com/oldmaid/assets/main.htm"));
        startActivity(browserIntent);
    }
    ...
    public void game4(View view) {
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.brainmetrix.com/reflex-test/"));
        startActivity(browserIntent);
    }
}
