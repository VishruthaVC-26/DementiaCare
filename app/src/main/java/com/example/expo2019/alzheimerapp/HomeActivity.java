...
public class HomeActivity extends AppCompatActivity
       ...
       //sending message button
        ...
        callFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (emg1_pno == null || emg1_pno.isEmpty()) {
                    Toast.makeText(getApplicationContext(), "No emergency contact available!", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void sendMessage(){
        if (emg1_pno == null && emg2_pno == null) {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if(id == R.id.nav_reading){
          ...
          //  Toast.makeText(getApplicationContext(),"Games",Toast.LENGTH_SHORT).show();
            ...
            startActivity(new Intent(HomeActivity.this, ReturnHome.class));
        }
